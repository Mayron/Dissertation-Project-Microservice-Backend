...
{
    public class GroupProjectsAggregatorActor : BaseMultiPayloadAggregatorActor
    {
        public GroupProjectsAggregatorActor(MultiQuery multiQuery, IActorRef callback) : base(multiQuery, callback)
        {
        }
